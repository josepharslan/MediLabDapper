...
namespace MediLabDapper.Repositories.DepartmentRepositories
{
    public class DepartmentRepository : IDepartmentRepository
    {
        ...
        {
            string query = "Insert Into Departments(Name,Description) Values (@Name, @Description)";
        ...
        {
            string query = "Update Departments Set Name = @Name, Description = @Description Where DepartmentId = @DepartmentId";
